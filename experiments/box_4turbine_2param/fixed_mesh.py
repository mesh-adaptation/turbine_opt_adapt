"""Run the two-parameter test case on a fixed mesh.
...
if args.plot_setup:
    plot_box_setup("plots/setup.jpg", TwoParameterSetup)
...
# Run the optimiser
optimiser = QoIOptimiser(mesh_seq, ("xc", "yc"), parameters, method="gradient_descent")
